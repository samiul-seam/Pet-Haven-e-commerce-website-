      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-slate-100 p-5 rounded-lg border border-slate-300">
            <h4 className="font-bold text-teal-700 mb-2">Pet Management</h4>
            <p className="text-sm">
          ...
          <div className="bg-slate-100 p-5 rounded-lg border border-slate-300">
            <h4 className="font-bold text-teal-700 mb-2">Adoption System</h4>
            <p className="text-sm">
          ...
          <div className="bg-slate-100 p-5 rounded-lg border border-slate-300">
            <h4 className="font-bold text-teal-700 mb-2">Review & Ratings</h4>
            <p className="text-sm">
          ...
          <div className="bg-slate-100 p-5 rounded-lg border border-slate-300">
            <h4 className="font-bold text-teal-700 mb-2">Advanced Filtering</h4>
            <p className="text-sm">
